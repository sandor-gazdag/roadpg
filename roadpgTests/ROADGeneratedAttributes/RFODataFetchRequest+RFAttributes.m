...
+ (NSArray *)RF_attributesForClass {
    NSMutableArray *RF_attributes_list__class_RFODataFetchRequest = [RFAttributeCacheManager objectForKey:@"RFAL__class_RFODataFetchRequest"];
    ...
    [RFAttributeCacheManager setObject:attributesArray forKey:@"RFAL__class_RFODataFetchRequest"];
